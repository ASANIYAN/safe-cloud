  ...
  return (
    <>
      <i
        ...
        className="fa-solid fa-bars text-googleBtnText text-xl mt-5 ml-3 cursor-pointer"
      ></i>
      <aside
        ref={sideBarRef}
        className={`w-64 h-screen absolute z-10 ${
        ...
        <nav className="py-4 px-3 h-full bg-sideBar">
          <div className="flex justify-between">
            ...
            <i
              ...
              className="fa-solid block fa-xmark pt-3 text-right text-white w-full cursor-pointer text-2xl"
            ></i>
          </div>
          <ul className="space-y-5 text-white mt-3">
            <li>
              <Link
                to="/"
                className="flex items-center p-2 text-base font-normal  rounded-lg hover:bg-sideBarHover"
              >
            ...
            <li>
              <Link
                to="/recovery"
                className="flex items-center p-2 text-base font-normal rounded-lg dark:text-white hover:bg-sideBarHover"
              >
