    ...
    <>
      <section className="container mt-10">
        <section className="w-full max-w-md mx-auto">
          <h1 className="text-center text-3xl text-black">General info</h1>
          {error && (
            <section
              className="bg-red-100 rounded-lg py-2 px-6 mt-4 text-base text-red-700 mb-3 text-center"
              role="alert"
            >
              {error}
            </section>
          ...
          <form onSubmit={SubmitInfo} className="mt-10">
            ...
            <section className="mt-6">
              <label htmlFor="lastName" className="text-gray-400 text-sm block">
                Last name
              </label>
              <input
                type="text"
          ...
          <section className="mt-4">
            ...
            >
              ...
              <span className="text-googleBtnText">Continue with Google</span>
            </button>
          </section>
          <p className="text-center pt-4">
            Already have an account? Click{" "}
            <Link to="/login" className="text-googleBtnText">
              {" "}
              here{" "}
            </Link>{" "}
            to Log in.
