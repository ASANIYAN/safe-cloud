...
const Setpassword = () => {
    ...
    const [ passwordInputType, visibility, setVisibility, repeatInputType, repeatVisibility, setRepeatVisibility ] = PasswordToggle();
        ...
        <>
            <div className="container mt-10">
                <div className="w-full max-w-md mx-auto">
                    ...
                    {
                            error && <div className="bg-red-100 rounded-lg py-2 px-6 mt-6 text-base text-red-700 mb-2 text-center" role="alert">
                            {error}
                        </div>
                        }
                    <form onSubmit={handleSubmit} className="mt-8">
                        <div className="mt-6">
                            <label htmlFor="Password" className="text-gray-400 text-sm block">Password</label>
                                <div className="relative">
                                    ...
                                    <span className="password-toggle-icon mt-4 absolute right-2">
                                        <i className={`fa-solid cursor-pointer ${visibility ? "fa-eye-slash" : "fa-eye"}`}
                        ...
                        <div className="mt-6">
                            <label htmlFor="repeatPassword" className="text-gray-400 text-sm block">Repeat password</label>
                            <div className="relative">
                                <input 
                                ...
                                />
                                <span className="password-toggle-icon mt-4 absolute right-2">
                                    <i className={`fa-solid cursor-pointer ${repeatVisibility ? "fa-eye-slash" : "fa-eye"}`}
                                    onClick={ () => setRepeatVisibility(repeatVisibility => !repeatVisibility) }
                                    ></i>
                                </span>
                            </div>
                        </div>
