        ...
        <div className="container mt-14">
            <div className="w-full max-w-md mx-auto">
                <h1 className="text-center text-3xl text-black">
                    ...
                    {
                        error && <div className="bg-red-100 rounded-lg py-2 px-6 mb-3 mt-6 text-base text-red-700 text-center" role="alert">
                        {error}
                      </div>
                    }
                    {
                        message && <div className="p-4 mb-3 mt-6 text-sm text-green-700 bg-green-100 rounded-lg dark:bg-green-200 dark:text-green-800 text-center" role="alert">
                        {message}
                      </div>
                    }
