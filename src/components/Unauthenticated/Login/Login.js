        ...
        <div className="container mt-14">
            <div className="w-full max-w-md mx-auto">
                <h1 className="text-center text-3xl text-black">
                    ...
                    {
                        error && <div className="bg-red-100 rounded-lg py-2 px-6 mb-3 mt-4 text-base text-red-700 text-center" role="alert">
                        {error}
                      </div>
                    }
                ...
                <p className="text-center pt-4">
                    Don't have an account? Click <Link to="/" className="text-googleBtnText"> here </Link> to Create one.
                </p>
